...
- Samo-opravné kódy.
### Předměty:
1. NTIN099 Algoritmy pro reprezentaci znalostí
2. NAIL094 Rozhodovací procedury a SAT/SMT řešiče
3. ✓ NTIN097 Struktury v hyperkrychlích
4. ✓ NAIL021 Booleovské funkce a jejich aplikace
---
# 3. Algoritmy
...
### Předměty:
1. ✓ NDMI010 Grafové algoritmy
2. NDMI018 Aproximační a online algoritmy
3. NDMI025 Pravděpodobnostní algoritmy
4. ✓ NTIN103 Introduction to Parameterized Algorithms
---
# 4. Datové struktury
...
- Textové algoritmy.
- Struktury pro práci s grafy.
- Dynamizace a persistence.
- Práce s paměťovou hierarchií.
- Data-streamové problémy.
### Předměty:
1. NTIN100 Základy přenosu a zpracování informace
2. NTIN067 Datové struktury 2
3. NTIN087 Textové algoritmy
4. ✓ NDMI010 Grafové algoritmy
5. NSWI072 Algoritmy komprese dat