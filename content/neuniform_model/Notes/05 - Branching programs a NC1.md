...
Zdrojové stránky: ![[../Assets/pages/page-23.png]], ![[../Assets/pages/page-24.png]], ![[../Assets/pages/page-25.png]], ![[../Assets/pages/page-26.png]], ![[../Assets/pages/page-27.png]], ![[../Assets/pages/page-28.png]], ![[../Assets/pages/page-30.png]]
...
Věta (Barrington, Ben-Or, Cleve):

Formuli hloubky $d$ nad oborem $R$ s proměnnými $x_1,
\dots,x_n$ lze vyhodnotit registrovým programem délky

$$
\leq 4^d
$$

se třemi registry nad $R$.

Tím se ukazuje souvislost $NC^1$ a branching programů konstantní šířky.

## Okruhy a formule

Okruh nad strukturou

$$
(R,+,\cdot)
$$

nemusí být multiplikativní grupa. Příklady struktur:
...
jsou pracovní registry, a

$$
x_1,\dots,x_n
$$

jsou vstupní registry. Hodnoty jsou z $R$.
...
$$
r_1 \leftarrow x_{13}-x_2,
$$

$$
r_2 \leftarrow x_4+x_2,
$$

$$
r_3 \leftarrow x_1\cdot x_4,
$$

$$
r_4 \leftarrow x_{12}-x_3,
$$

$$
r_5 \leftarrow r_1\cdot r_2,
$$
...
Formuli hloubky $d$ nad okruhem $R$ s proměnnými lze vyhodnotit registrovým programem délky
...
Cíl pro formuli $f(x_1,
\dots,x_n)$:

chceme zkonstruovat program ekvivalentní transformacím
...
kde na počátku nastavíme $r_1=0$ a $r_2=1$, takže na konci máme
...
Věta (Barrington 1987):

Pokud je $f_n$ počitatelná booleovskou formulí hloubky $d$, lze ji počítat také branching programem délky $\leq 4^d$ a šířky $5$.

Pozdější konstrukce dává i mírně slabší/obdobný výsledek délky $\leq 4^{3d}$ a šířky $8$.
