...
Uvažujme **binární symetrický kanál** s $p=p_{0}=p_{1}$, s $X_{1}X_{2}X_{3}\dots$ jako pravděpodobnost chyby nezávislých veličin. Předpoklad o nezávislosti není realistický, jen ho pak aproximujeme v praxi, třeba zpřeházením datových bloků.
...
R = \frac{k}{n} \in [0,1],
$$
který se snažíme maximalizovat, kde $k$ je počet bitů které chceme "bez chyby" přenést a $n$ je kolik bitů se pošle.
