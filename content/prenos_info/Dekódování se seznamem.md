...
## Hadamardův kód
$\left[ 2^k,k, \frac{1}{2} 2^k \right]_{2}$, tedy vlastně pro volbu $k$ $\left[ n,\log n, \frac{n}{2} \right]$. Mějme 
$$
...
Principiálně se jedná o to samé jako u *private information retrieval*, nebol-li dopočtení informace, kterou potřebujeme ze serveru, tak aby server netušil co přesně jsme chtěli.
