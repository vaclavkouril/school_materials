...
*Důkaz:* Mějme libovolný jazyk $L_{1} \in NSPACE(S_{1}(f(n)))$, pro který  existuje NTS $M_{1}$, který ho rozhoduje. Definujme si, pro \$, který nebyl v pracovní abecedě $M_{1}$
$$
